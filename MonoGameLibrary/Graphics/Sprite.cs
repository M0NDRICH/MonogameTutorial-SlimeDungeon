...
namespace MonoGameLibrary.Graphics
{
    public class Sprite
    {
        ...
        // param name="region" - The texture region to use as the source texture region for this sprite.
        ...
        // param name="position" - The xy-coordinate position to render this sprite at.
